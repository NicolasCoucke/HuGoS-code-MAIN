...
public class BLOCKLavaSpawner : MonoBehaviourPunCallbacks, IPunObservable
{
    ...
    void Spawn_next_lava(Vector3 position, float start_size)
    {
        if (PhotonNetwork.IsMasterClient)
        {
            ...
            SpawnedLava.GetComponent<BLOCKLavaGenerator>().Submit_radia(startradius, endradius);
    ...
    public void DefineSequence(int Trial)
    {
        ...
        if (Trial == 1)
        {
            ...
            Hole_positions.Add(new Vector3(40f, 0f, 40f));
            Hole_positions.Add(new Vector3(-40f, 0f, -40f));
